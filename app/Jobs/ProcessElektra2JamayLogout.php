...
class ProcessElektra2JamayLogout implements ShouldQueue
{
    ...
    public function handle()
    {
        ...
        $telcelUser = TelcelUser::find(7);

        $consulta2 = TelcelUser::checkIn($urlapi, $telcelUser, "20.2906", "-102.7104", "2");

        $consulta3 = TelcelUser::posicion($urlapi, $telcelUser, "20.2906", "-102.7104", "CheckOut");
